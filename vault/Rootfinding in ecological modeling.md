...
Logan's poster points at two different meanings of stability distinct from the definition of [[Stability|numerical stability]] we learned in class. Directly in the poster, he references "structural stability," and he alludes to another concept of stability called "dynamical stability" often used in the field of ecological modeling. These three definitions are each distinct, but also similar.[^1]
...
# Continuation is repeated rootfinding as a parameter changes
...
Logan's Figure 4 can be interpreted through this framework of bifurcation, although the underlying ecological model is likely more complicated. The plotted trait branches show how the evolutionarily stable community changes as $T_{amp}$ changes. Branches separate, disappear entirely, or become unstable in different regions.[^1]
